class ZCL_ZAGR_BOPF_MPC definition
  public
...
public section.
  ...
  types:
          MAXROWS type BAPI_EPM_MAX_ROWS .
  types:
  ...
  types:
         TS_BPCONTACTDATA type BAPI_EPM_BP_CONTACT .
  types:
    TT_BPCONTACTDATA type standard table of TS_BPCONTACTDATA .
  types:
         TS_BPHEADERDATA type BAPI_EPM_BP_HEADER .
  types:
    TT_BPHEADERDATA type standard table of TS_BPHEADERDATA .
  types:
         TS_RETURN type BAPIRET2 .
  types:
    TT_RETURN type standard table of TS_RETURN .
  types:
         TS_SELPARAMBPID type BAPI_EPM_BP_ID_RANGE .
  types:
    TT_SELPARAMBPID type standard table of TS_SELPARAMBPID .
  types:
         TS_SELPARAMCOMPANYNAME type BAPI_EPM_COMPANY_NAME_RANGE .
  types:
    TT_SELPARAMCOMPANYNAME type standard table of TS_SELPARAMCOMPANYNAME .

  constants GC_BPCONTACTDATA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Bpcontactdata' ##NO_TEXT.
  constants GC_BPHEADERDATA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Bpheaderdata' ##NO_TEXT.
  constants GC_MAXROWS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Maxrows' ##NO_TEXT.
  constants GC_RETURN type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Return' ##NO_TEXT.
  constants GC_SELPARAMBPID type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Selparambpid' ##NO_TEXT.
  constants GC_SELPARAMCOMPANYNAME type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Selparamcompanyname' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_COMPLEXTYPES
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_BPCONTACTDATA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_BPHEADERDATA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_RETURN
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SELPARAMBPID
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SELPARAMCOMPANYNAME
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZAGR_BOPF_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZAGR_BOPF_SRV' ).

define_complextypes( ).
define_bpcontactdata( ).
define_bpheaderdata( ).
define_return( ).
define_selparambpid( ).
define_selparamcompanyname( ).
  endmethod.


  method DEFINE_BPCONTACTDATA.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - Bpcontactdata
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Bpcontactdata' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MiddleName' iv_abap_fieldname = 'MIDDLE_NAME' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 40 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPI_EPM_BP_CONTACT'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BpcontactdataSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Bpheaderdata' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'BpheaderdataSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   COMPLEX TYPE - Maxrows
***********************************************************************************************************************************
lo_complex_type = model->create_complex_type( 'Maxrows' ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************
lo_property = lo_complex_type->create_property( iv_property_name  = 'Bapimaxrow' iv_abap_fieldname = 'BAPIMAXROW' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name   = 'BAPI_EPM_MAX_ROWS'
                                 iv_bind_conversions = 'X' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Selparambpid' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPI_EPM_BP_ID_RANGE'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SelparambpidSet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_SELPARAMCOMPANYNAME.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - Selparamcompanyname
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Selparamcompanyname' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'BAPI_EPM_COMPANY_NAME_RANGE'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'SelparamcompanynameSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20171110120222'.                  "#EC NOTEXT

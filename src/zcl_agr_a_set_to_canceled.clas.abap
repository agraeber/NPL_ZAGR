class ZCL_AGR_A_SET_TO_CANCELED definition
  public
...
CLASS ZCL_AGR_A_SET_TO_CANCELED IMPLEMENTATION.
  ...
  method /BOBF/IF_FRW_ACTION~EXECUTE.
      ...
      WHEN zif_agr_i_salesorder_tx_c=>sc_action-zagr_i_salesorder_tx-set_to_canceled.
        ...
        IF sy-subrc = 0.
            <fs_sales_order>-lifecyclestatus  = 'S'.
        ENDIF.

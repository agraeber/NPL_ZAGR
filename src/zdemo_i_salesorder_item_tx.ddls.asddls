@AbapCatalog.sqlViewName: 'ZAGRDEMO_I_SOI'
...
define view Zdemo_I_Salesorder_Item_tx

  as select from zagrtab_soi as Item
  association [1..1] to ZAGRDEMO_I_SalesOrder_TX  as _SalesOrder on $projection.SalesOrder = _SalesOrder.SalesOrder
